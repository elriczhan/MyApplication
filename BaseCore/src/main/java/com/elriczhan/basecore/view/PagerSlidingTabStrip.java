...
//                    ViewHelper.setPivotY(frameLayout, frameLayout.getMeasuredHeight() * 0.5f);
                    frameLayout.setPivotY(frameLayout.getMeasuredWidth() * 0.5f);
...
//            ViewHelper.setPivotY(v_old, v_old.getMeasuredHeight() * 0.5f);
            v_old.setPivotY(v_old.getMeasuredWidth() * 0.5f);
...
//            ViewHelper.setPivotY(v_new, v_new.getMeasuredHeight() * 0.5f);
            v_new.setPivotY(v_new.getMeasuredWidth() * 0.5f);
...
//                ViewHelper.setPivotY(left, left.getMeasuredHeight() * 0.5f);
                left.setPivotY(left.getMeasuredWidth() * 0.5f);
...
//                ViewHelper.setPivotY(right, right.getMeasuredHeight() * 0.5f);
                right.setPivotY(right.getMeasuredWidth() * 0.5f);
